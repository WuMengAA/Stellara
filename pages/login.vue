        ...
        <div class="decor-content">
          ...
          <div class="decor-illustration">
            <svg width="280" height="280" viewBox="0 0 280 280" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M140 60 Q120 100 60 100" stroke="currentColor" stroke-width="1.5" opacity=".15" stroke-linecap="round"/>
              <circle cx="140" cy="140" r="16" fill="currentColor" opacity=".06"/>
            </svg>
          </div>
          <h2 class="decor-title">Welcome to Stellara</h2>
          <p class="decor-desc">A place where stars meet code — share your ideas with the world</p>
          <div class="decor-tags">
            <span class="decor-tag">✦ Minimal</span>
            <span class="decor-tag">✦ Modern</span>
            <span class="decor-tag">✦ Yours</span>
          </div>
        </div>
      </div>
      ...
      <div class="login-form-side">
        <div class="form-panel">
          <div class="form-header">
            <h1>Welcome Back</h1>
            <p>Sign in to your Stellara account</p>
          </div>
          ...
          <form @submit.prevent="handleLogin" class="form-body">
            ...
            <div class="field">
              ...
              <div class="input-wrap">
                ...
                <input id="password" v-model="password" :type="showPw ? 'text' : 'password'" required placeholder="••••••••" />
